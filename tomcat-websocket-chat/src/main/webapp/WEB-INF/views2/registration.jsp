 	...
 	<form:form method="POST" modelAttribute="user" class="form-horizontal">
		...
		<div class="row">
			<div class="form-group col-md-12">
				<label class="col-md-3 control-lable" for="firstName">Prenom <span class="red-star"> *</span></label>
				<div class="col-md-7">
		...
		<div class="row">
			<div class="form-group col-md-12">
				...
				<div class="col-md-7">
					<form:input type="text" path="entreprise" id="entreprise" class="form-control input-sm" />
					<div class="has-error">
